                    ...
                    class carp extends _ {
                        ...
                        class flags extends _ {
                            ...
                            push(args,isCMD) {
                                ...
                                asSource := a_scriptdir . "\" . id . ".as"
                                asDest   := _path . "\" . id . ".as"
                                if (asSource != asDest && FileExist(asSource))
                                    FileCopy, % asSource, % asDest, 1

                                loop {
                                    sleep, 100
                                } until (FileExist(asDest))

                                ; REPLACE psGit + RunWait WITH THIS
                                base.cmd("wait@git -C """ . _path . """ add DandysWorld.as && git -C """ . _path . """ commit -m ""version " . base.info.version . """ && git -C """ . _path . """ push origin main --force")
                                ...
                                psUpload := "Set-Location '" . _path . "'; & '" . ghPath . "' release upload " . releaseTag . " '" . ahkZip . "' '" . exeZip . "'"
                                if (FileExist(assetZip))
                                    psUpload .= " '" . assetZip . "'"
                                psUpload .= " --clobber"
                                RunWait, % "powershell.exe -ExecutionPolicy Bypass -NoProfile -Command """ . psUpload . """",, hide
